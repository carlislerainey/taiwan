...
\vspace{3mm}
Carlisle Rainey\symbolfootnote[1]{I thank Jason Barabas, Bob Jackson, Dave Siegel, and Deb Sinha for helpful comments on previous versions of this manuscript.}\\
...
%For the most recent draft of this manuscript,\\see \href{http://www.carlislerainey.com/research/arguing-for-a-negligible-effect}{crain.co/nme}.
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figs/TurnoutDensity.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics[width=\textwidth]{figs/TurnoutModels.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics{figs/RepresentedDensity.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics{figs/RepresentedModels.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics[width=\textwidth]{figs/CloseDensity.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics[width=\textwidth]{figs/CloseModels.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics[width=\textwidth]{figs/ContactedDensity.pdf}
...
\newpage
\begin{figure}[h]
\includegraphics[width=\textwidth]{figs/ContactedModels.pdf}
