...
print(xtable(summary(bma1, digits = 2),
      ...
      have a non-zero impact on feeling represented, the posterior means and standard deviations, and the 
      ...
      effect is estimated to be 0.02.",
             label = "tab:close"), 
      file = "doc/tabs/represented_table.tex", size="\\scriptsize")